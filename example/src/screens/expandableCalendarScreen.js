...
const ExpandableCalendarScreen = (props) => {
    ...
    const renderHeader = useCallback((date) => {
        ...
        return (<View style={styles.header}>
          ...
          <TouchableOpacity accessibilityRole="button" accessibilityLabel="Open month and year picker" testID={`${testIDs.expandableCalendar.CONTAINER}.openPickerButton`} onPress={() => setPickerVisible(true)} style={{ paddingHorizontal: 6, paddingVertical: 4, marginLeft: 6 }}>
    ...
    return (<CalendarProvider date={providerDate} 
    ...
    sectionStyle={styles.section}/>
      <MonthYearPicker visible={pickerVisible} initialDate={new XDateClass(providerDate)} onClose={() => setPickerVisible(false)} onConfirm={(monthIndex, year) => {
