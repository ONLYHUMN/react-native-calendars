...
const Calendar = (props) => {
    ...
    const renderHeader = () => {
        ...
        return (<HeaderComponent {...headerProps} testID={`${testID}.header`} style={headerStyle} ref={ref} month={currentMonth} addMonth={addMonth} displayLoadingIndicator={shouldDisplayIndicator} titlePressOpensMonthYearPicker showPickerButton={false}/>);
    };
